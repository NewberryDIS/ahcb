      ...
      onEachFeature: function (feature, layer) {
        ...
        layer.on({
          mouseover: function (e) {
            ...
            // mapdiv.style.backgroundImage = `url("/ahcb/static/images/pcards/${stateCode}_postcard_bg.webp")`;
            const leftStates = [
              "AK",
              "AZ",
              "CA",
            ...
            if (externalTTImg1)
              externalTTImg1.src = `/ahcb/static/images/pcards/${stateCode}_postcard_bg.webp`;

            if (externalTTImg2)
              externalTTImg2.src = `/ahcb/static/images/pcards/${stateCode}_postcard_fg.webp`;
            if (externalTTLink) externalTTLink.href = `/ahcb/${stateCode}`;
          },
          mouseout: function (e) {
            e.target.setStyle({
              fillColor: "var(--fg-color)",
          ...
          click: function (e) {
            window.location = `/ahcb/${stateCode}`;
            // htmx.ajax("GET", `/ahcb/${stateCode}`, { target: "body" });
          },
        });
