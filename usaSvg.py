...
usaSvg = Svg(
    Title("Blank map of the United States, territories not included"),
    Defs(
        Style(
    ...
    G(
        ...
        Path(d="m 620.9,365.1 1.3,2 -1.3,67 4.4,33.2", cls="al-ms"),
        Path(d="m 620.9,365.1 45.7,-4", cls="al-tn"),
        Path(d="m 516.7,414.2 52.3,-1.3", cls="ar-la"),
        Path(
        ...
        Path(d="m 507.9,400.5 .7,-39 -4.1,-24.4", cls="ar-ok"),
        Path(
        ...
        Path(d="m 507.9,400.5 2.6,2.3 2.8,-1.3 3.2,.8 .2,11.9", cls="ar-tx"),
        Path(
        ...
        Path(d="m 253.8,311 -17.4,124.1", cls="az-nm"),
        Path(
            d="m 167.6,296.8 -3.4,17.5 -2.4,2.9 h -2 l -1.2,-2.7 -3.7,-1.4 -3.5,.6 -1,13.6 .5,4.9 -.5,2.9 -1.4,3",
            cls="az-nv",
        ),
        Path(d="m 167.6,296.8 46.2,8.2 40,6", cls="az-ut"),
        Path(d="m 93.9,166.5 -16.4,63.1 1.1,3.5 70.4,105", cls="ca-nv"),
        Path(d="m 27.8,147.9 66.1,18.6", cls="ca-or"),
        Path(d="m 379.4,256.3 -4.8,67", cls="co-ks"),
        Path(d="m 347.7,231.8 33.1,2.4 -1.4,22.1", cls="co-ne"),
        Path(d="m 253.8,311 52.6,6.5 51.7,4.8", cls="co-nm"),
        Path(d="m 358.1,322.3 16.5,1", cls="co-ok"),
        Path(d="m 265.3,222.7 -11.5,88.3", cls="co-ut"),
        Path(d="m 265.3,222.7 44.9,5.7 37.5,3.4", cls="co-wy"),
        Path(
            d="m 843.8,171.3 10.5,-2.4 .5,.7 .9,-.3 0,-.7 14.9,-3.4 .1,.3", cls="ct-ma"
        ),
        Path(d="m 846.6,194.7 -1.7,-2.2 3.5,-3.4 -1.8,-1.5 -2.8,-16.3", cls="ct-ny"),
        Path(d="m 870.7,165.5 3.2,12.3 -.4,1.1 .4,1.8", cls="ct-ri"),
        Path(d="m 801.8,254.6 1.7,-2.6 -2.6,-1.8 -1,1.7", cls="dc-md"),
        Path(d="m 799.9,251.9 .5,.4 .4,.1 .6,.5 .3,.7 -.1,.5 .2,.5", cls="dc-va"),
        Path(d="m 817.9,230.1 7.6,27.1 10.9,-2.3", cls="de-md"),
        Path(d="m 823.8,227.2 -1,2.2 -.3,2.1", cls="de-nj"),
        Path(d="m 817.9,230.1 1.2,-2.1 1.5,-1.1 1.6,-.3 1.6,.6", cls="de-pa"),
        Path(
            d="m 687.6,447.4 3.3,6 50.1,-3.3 .6,3.2 1,1.1 2.1,-.6 .5,-4.3 -1.4,-2.1 v -2.5 l 2.2,-1.4 1.7,.9 4,.7 3.6,-.3",
            cls="fl-ga",
        ),
        Path(d="m 689.5,358.2 21.4,-3", cls="ga-nc"),
        Path(
        ...
        Path(d="m 666.6,361.1 22.9,-2.9", cls="ga-tn"),
        Path(
        ...
        Path(d="m 473.6,182 28.2,0 36.3,-.9 18.6,-.7", cls="ia-mn"),
        Path(
        ...
        Path(d="m 140.9,177.7 24.4,5.4 23.3,4.7", cls="id-nv"),
        Path(
        ...
        Path(d="m 236.5,196 -47.9,-8.2", cls="id-ut"),
        Path(d="m 174.6,27.5 -12.7,56.1 .7,4 -1.1,4.3", cls="id-wa"),
        Path(d="m 245,141.2 -8.5,54.8", cls="id-wy"),
        Path(
        ...
        Path(d="m 567.2,202 45.9,-2.8", cls="il-wi"),
        Path(
        ...
        Path(d="m 630.9,213.2 32.4,-3.4 .1,1.4", cls="in-mi"),
        Path(d="m 670,268.4 -6.6,-57.2", cls="in-oh"),
        Path(
            d="m 504.3,326.3 -.5,-48.1 -3.2,-.7 -2.6,-4.7 -2.5,-2.5 .5,-2.3 2.7,-2.6 .1,-1.2 -1.5,-2.1 -.9,1 -2,-.6 -2.9,-3",
            cls="ks-mo",
        ),
        Path(d="m 379.4,256.3 36,2 43.7,1.2 h 32.4", cls="ks-ne"),
        Path(d="m 374.6,323.3 67.7,2.9 62,.1", cls="ks-ok"),
        Path(
        ...
        Path(d="m 843.8,171.3 -.7,-1 .5,-15", cls="ma-ny"),
        Path(
            d="m 870.7,165.5 6.5,-2 .7,2.6 h .8 l .6,2.2 2.6,1.3 1.3,1.1 1.4,3",
            cls="ma-ri",
        ),
        Path(d="m 843.6,155.3 12.4,-2.7", cls="ma-vt"),
        Path(d="m 757.4,241.9 60.5,-11.8", cls="md-pa"),
        Path(
        ...
        Path(
            d="m 881.9,138.3 -2.3,-1.4 -.8,-2.2 -3.2,-2 -.6,-4 -11.9,-36.8", cls="me-nh"
        ),
        Path(d="m 663.4,211.2 21.4,-3.5", cls="mi-oh"),
        Path(
        ...
        Path(d="m 491.5,259.5 -3.9,-6.3 -2.1,-3.7 .3,-1.4 -1.3,-1.3", cls="mo-ne"),
        Path(d="m 504.3,326.3 .2,10.8", cls="mo-ok"),
        Path(
            d="m 591.7,344.9 1,-2 1.2,-.5 v -.7 l -1.2,-1.1 -.6,-1 1.7,.2 .8,-.7 -1.4,-1.5 1.4,-.5 .1,-1 -.6,-1 0,-1.3 m 1,0 .8,.7 .8,-1",
            cls="mo-tn",
        ),
        Path(d="m 582.6,367.7 38.3,-2.6", cls="ms-tn"),
        Path(d="m 362.5,56.3 -5.2,66.7", cls="mt-nd"),
        Path(d="m 357.3,123 -2,20.7", cls="mt-sd"),
        Path(d="m 355.3,143.7 -51,-5.3 -57.3,-7.9 -2,10.7", cls="mt-wy"),
        Path(
        ...
        Path(d="m 731.1,317 29.4,-3.5 39.4,-7.3 29.1,-6.1", cls="nc-va"),
        Path(d="m 357.3,123 39.2,2.9 46,2.1 29.5,.4", cls="nd-sd"),
        Path(
        ...
        Path(d="m 347.7,231.8 3.7,-44.2", cls="ne-wy"),
        Path(
        ...
        Path(d="m 827.9,190.5 14.6,4.9 -.4,5.9", cls="nj-ny"),
        Path(
        ...
        Path(d="m 358.1,322.3 -.6,10.6", cls="nm-ok"),
        Path(
            d="m 284.3,431.2 -2,-2.2 .3,-3 34.4,3.6 31.8,2.6 7.9,-99.3 .8,0",
            cls="nm-tx",
        ),
        Path(d="m 93.9,166.5 47,11.2", cls="nv-or"),
        Path(d="m 188.6,187.8 -21,109", cls="nv-ut"),
        Path(
        ...
        Path(d="m 736.8,225.1 -4.9,-29.9", cls="oh-pa"),
        Path(
        ...
        Path(d="m 736.8,225.1 3.2,19.7 17.4,-2.9", cls="pa-wv"),
        Path(d="m 351.4,187.6 3.9,-43.9", cls="sd-wy"),
        Path(d="m 697.7,321.1 28.9,-3.3 .2,-1 4.6,-.5 -.3,.7", cls="tn-va"),
        Path(d="m 236.5,196 -3.3,21.9 32.1,4.8", cls="ut-wy"),
        Path(
