...
KMZ files for the US are provided both with and without Alaska & Hawaii. The following chart shows the approximate scale at which the generalization becomes noticeable on map polygons:
